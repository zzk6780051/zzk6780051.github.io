...
### [我的博客在这里 →](http://zzk6780051.github.io)
...
我的博客仓库——`zzk6780051.github.io`，是经常修改的，而且还会有人乱提交代码，因此给大家做了一个稳定版的模板。大家可以直接fork模板——`huxblog-boilerplate`,要改的地方我都说明了。或者可以直接下载zip到本地自己去修改。

```
$ git clone git@github.com:zzk6780051/huxblog-boilerplate.git
```
...
* 解决了代码过长自动换行的bug,替换为横向滚动条。详情请见[issue#15](https://github.com/zzk6780051/zzk6780051.github.io/issues/15)
...
* 如果你喜欢我的这个博客模板，请在`zzk6780051.github.io`这个repository点个赞——右上角**star**一下。
...
# SNS settings      
github_username: zzk6780051     # 你的github账号
weibo_username: zzk6780051      # 你的微博账号，底部链接会自动更新的。
...
标题底图是可以自己选的，看看几篇示例post你就知道如何设置了。在
  [issue #6 ](https://github.com/zzk6780051/zzk6780051.github.io/issues/6) 中我被问到：怎么样才能让标题底图好看呢？
